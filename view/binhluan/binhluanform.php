...
<body>
    <div class="border border-[#15146] ">
        <div class="text-2xl border-b text-[22px] font-bold  bg-gray-200 pl-[10px]">Bình Luận</div>
        ...
        <div class=" p-2 bg-[#FFEEEE]">
            <form action="<?=$_SERVER['PHP_SELF'];?>" method="post" class="flex space-x-2">
                ...
                <input class="border w-full px-2 py-1 " name="noidung" type="text" placeholder="Tìm kiếm tên danh mục">
