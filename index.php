    ...
    switch($act){
        ...
        case 'dangky':
            if (isset($_POST['dangky']) && ($_POST['dangky'])) {
                    ...
                    insert_taikhoan($email, $user, $password); // nhập vào
        ...
        case 'edit_taikhoan':
            if (isset($_POST['capnhat']) && ($_POST['capnhat'])) {
                   ...
                   $_SESSION['user'] = checkuser($user,$password);//cập nhật lại hàm session user chuyển trang để có thông tin mới cho phần đăng nhập
            }
        ...
        case 'quenmk':
            if (isset($_POST['guiemail']) && ($_POST['guiemail'])) {
                    ...
                    if(is_array($checkemail)){
                        $thongbao ="mật khẩu của bạn là : ". $checkemail['password']; // là 1 cái ky của mảng email  
                    }else{
